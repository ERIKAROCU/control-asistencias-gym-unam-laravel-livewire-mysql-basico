        ...
        <table class="w-full border-collapse border border-gray-300">
            <thead>
                <tr class="bg-gray-200">
                    <th class="py-2 px-4 border-b text-left text-sm font-medium text-gray-900">ID</th>
                    <th class="py-2 px-4 border-b text-left text-sm font-medium text-gray-900">Nombres</th>
                    <th class="py-2 px-4 border-b text-left text-sm font-medium text-gray-900">Email</th>
            ...
            <tbody> 
                @foreach ($usuarios as $usuario)
                    <tr wire:key="usuario-{{ $usuario->id }}">
                        <td class="py-2 px-4 border-b text-sm text-gray-800">{{ $usuario->id }}</td>
                        ...
                        <td class="py-2 px-4 border-b text-sm text-gray-800">{{ $usuario->rol ? 'Admin' : 'Usuario' }}</td>
